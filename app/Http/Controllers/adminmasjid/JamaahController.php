...
class JamaahController extends Controller
{
    ...
    protected function validatedData(Request $request, ?int $ignoreId = null): array
    {
        ...
        // Hapus 'foto' dari array validated data teks biasa 
        // karena penyimpanan file ditangani terpisah di store/update.
        // (Atau biarkan jika Anda ingin memasukkannya langsung ke database setelah di-store)
